...
public class ModItemTagProvider extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        tag(Tags.Items.TRANSFORMABLE_ITEMS).add(AmberDreams.Items.BISMUTH.get()).add(AmberDreams.Items.RAW_BISMUTH.get()).add(Items.COAL).add(Items.STICK).add(Items.COMPASS);
    }
}
